...
public final class BarUtils {
    ...
    private static View createStatusBarView(final Context mContext,
                                            final int color) {
        View statusBarView = new View(mContext);
        statusBarView.setLayoutParams(new ViewGroup.LayoutParams(
                ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(mContext)));
    ...
    public static void setNotificationBarVisibility(Context mContext, final boolean isVisible) {
        String methodName;
        if (isVisible) {
        ...
        invokePanels(mContext, methodName);
    }

    private static void invokePanels(Context mContext, final String methodName) {
        try {
     ...
     * @return the navigation bar's height
     */
    public static int getNavBarHeight(Context mContext) {
    ...
    public static void setNavBarVisibility(@NonNull final Window window, boolean isVisible) {
        ...
        for (int i = 0, count = decorView.getChildCount(); i < count; i++) {
            ...
            if (id != View.NO_ID) {
                String resourceEntryName = getResNameById(decorView.getContext(), id);
    ...
    public static boolean isNavBarVisible(@NonNull final Window window) {
        ...
        if (isVisible) {
            ...
            if (RomUtils.isSamsung()
                ...
                try {
                    return Settings.Global.getInt(decorView.getContext().getContentResolver(), "navigationbar_hide_bar_enabled") == 0;
    ...
    private static String getResNameById(Context mContext, int id) {
        try {
     ...
     * @return {@code true}: yes<br>{@code false}: no
     */
    public static boolean isSupportNavBar(Context mContext) {
