...
public class StepsView extends View {
     ...
     * 线段的高度
     */
    private float mCompletedLineHeight = DisplayUtils.dp2px(getContext(), 2f);

    /**
     * 图标宽度
     */
    private float mIconWidth = DisplayUtils.dp2px(getContext(), 21.5f);
    /**
     * 图标的高度
     */
    private float mIconHeight = DisplayUtils.dp2px(getContext(), 24f);
    /**
     * UP宽度
     */
    private float mUpWidth = DisplayUtils.dp2px(getContext(), 20.5f);
    /**
     * up的高度
     */
    private float mUpHeight = DisplayUtils.dp2px(getContext(), 12f);

    /**
     * 线段长度
     */
    private float mLineWidth = DisplayUtils.dp2px(getContext(), 25f);
    ...
    private void init() {
        ...
        mTextNumberPaint.setTextSize(DisplayUtils.sp2px(getContext(), 10f));
        ...
        mTextDayPaint.setTextSize(DisplayUtils.sp2px(getContext(), 12f));
    ...
    private void setChange() {
        //图标的中中心Y点
        mCenterY = DisplayUtils.dp2px(getContext(), 28f) + mIconHeight / 2;
        ...
        //第一个点距离父控件左边14.5dp
        float size = mIconWidth / 2 + DisplayUtils.dp2px(getContext(), 23f);
        ...
        for (int i = 0; i < mCircleCenterPointPositionList.size(); i++) {
            ...
            if (stepsBean.getNumber() != 0) {
                ...
                Rect rectUp =
                        new Rect((int) (currentComplectedXPosition - mUpWidth / 2),
                                (int) (mCenterY - mIconHeight / 2 - DisplayUtils.dp2px(getContext(), 8f) - mUpHeight),
                                (int) (currentComplectedXPosition + mUpWidth / 2),
                                (int) (mCenterY - mIconHeight / 2 - DisplayUtils.dp2px(getContext(), 1f)));
            ...
            if (stepsBean.getNumber() != 0) {
                canvas.drawText("+" + stepsBean.getNumber(),
                        currentComplectedXPosition - DisplayUtils.dp2px(getContext(), 8f),
                        mCenterY / 2 - DisplayUtils.dp2px(getContext(), 0.5f),
                        mTextNumberPaint);
            }
            //天数文字
            canvas.drawText(stepsBean.getDay(),
                    currentComplectedXPosition - DisplayUtils.dp2px(getContext(), 12f),
                    mCenterY + DisplayUtils.dp2px(getContext(), 30f),
                    mTextDayPaint);
        }
