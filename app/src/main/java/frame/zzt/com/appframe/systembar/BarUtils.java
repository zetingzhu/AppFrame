...
public class BarUtils {
    ...
    public static void initBarUtils(Application app) {
        application = app;
    }
    ...
    public static boolean isNavBarVisible(@NonNull final Window window) {
        ...
        if (isVisible) {
            ...
            if (RomUtils.isSamsung()
                ...
                try {
                    return Settings.Global.getInt(getApp().getContentResolver(), "navigationbar_hide_bar_enabled") == 0;
    ...
    private static String getResNameById(int id) {
        try {
            return getApp().getResources().getResourceEntryName(id);
        } catch (Exception ignore) {
            return "";
        }
    }
