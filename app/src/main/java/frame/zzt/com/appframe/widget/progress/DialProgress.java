package frame.zzt.com.appframe.widget.progress;
...
public class DialProgress extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        mContext = context;
        mDefaultSize = MiscUtil.dipToPx(context, MiscUtil.DEFAULT_SIZE);
        mRectF = new RectF();
    ...
    private void initConfig(Context context, AttributeSet attrs) {
        ...
        mMaxValue = typedArray.getFloat(R.styleable.DialProgress_maxValue, MiscUtil.DEFAULT_MAX_VALUE);
        mValue = typedArray.getFloat(R.styleable.DialProgress_value, MiscUtil.DEFAULT_VALUE);
        mValueSize = typedArray.getDimension(R.styleable.DialProgress_valueSize, MiscUtil.DEFAULT_VALUE_SIZE);
        ...
        mUnitSize = typedArray.getDimension(R.styleable.DialProgress_unitSize, MiscUtil.DEFAULT_UNIT_SIZE);
        ...
        mHintSize = typedArray.getDimension(R.styleable.DialProgress_hintSize, MiscUtil.DEFAULT_HINT_SIZE);

        mArcWidth = typedArray.getDimension(R.styleable.DialProgress_arcWidth, MiscUtil.DEFAULT_ARC_WIDTH);

        mStartAngle = typedArray.getFloat(R.styleable.DialProgress_startAngle, MiscUtil.DEFAULT_START_ANGLE);
        mSweepAngle = typedArray.getFloat(R.styleable.DialProgress_sweepAngle, MiscUtil.DEFAULT_SWEEP_ANGLE);

        mAnimTime = typedArray.getInt(R.styleable.DialProgress_animTime, MiscUtil.DEFAULT_ANIM_TIME);
        ...
        mDialColor = typedArray.getColor(R.styleable.DialProgress_dialColor, Color.YELLOW);
